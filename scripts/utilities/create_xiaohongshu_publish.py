#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""创建XiaohongshuPublish.vue文件"""

content = '''<template>
  <div class="xiaohongshu-publish">
    <!-- 合规审查对话框 -->
        ...
        <el-card>
          ...
          <el-form :model="form" label-width="120px">
            ...
            <el-form-item label="手机号">
              <el-input v-model="form.username" placeholder="请输入小红书账号" />
            </el-form-item>
          ...
          <el-form :model="publishForm" label-width="100px">
            ...
            <el-form-item label="笔记内容">
              <el-input 
                ...
                placeholder="请输入笔记内容，支持emoji和标签"
                type="textarea"
                :rows="6"
                maxlength="1000"
                show-word-limit
            ...
            <el-form-item>
              <el-button 
                ...
                @click="handlePublish" 
                :loading="publishing"
                :disabled="!isLoggedIn || !publishForm.title"
              >
                🚀 发布笔记
              </el-button>
            </el-form-item>
...
const handleCoverSelect = (file: any) => {
  publishForm.value.coverImages.push(file.raw.path)
    ...
    const response = await axios.post(
      ...
      null,
      {
        params: {
          ...
          tags: data.tags,
          cover_images: JSON.stringify(data.coverImages)
        }
      }
    )
...
with open('frontend/src/views/XiaohongshuPublish.vue', 'w', encoding='utf-8') as f:
    f.write(content)

print("✅ XiaohongshuPublish.vue 创建成功！")
