          ...
          <el-form :model="publishForm" label-width="100px">
            <el-form-item label="视频文件">
              ...
              >
                ...
                <template #tip>
                  <div class="el-upload__tip">支持mp4/mov格式，最大500MB</div>
                </template>
              </el-upload>
            </el-form-item>
...
const executePublish = async () => {
  ...
  try {
    ...
    const response = await axios.post(
      'http://localhost:8000/api/v1/content/kuaishou/publish',
      null,
      {
        params: {
          account_id: form.value.accountId,
...
with open('frontend/src/views/KuaishouAccount.vue', 'w', encoding='utf-8') as f:
    f.write(content)

print("✅ KuaishouAccount.vue 创建成功！")
