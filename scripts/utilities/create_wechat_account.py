        ...
        <el-card>
          ...
          <el-form :model="form" label-width="120px">
            ...
            <el-form-item label="微信号/手机号">
              <el-input v-model="form.username" placeholder="请输入视频号账号" />
            </el-form-item>
          ...
          <el-form :model="publishForm" label-width="100px">
            <el-form-item label="视频文件">
              ...
              >
                ...
                <template #tip>
                  <div class="el-upload__tip">支持mp4格式，建议时长15-60秒</div>
                </template>
              </el-upload>
            </el-form-item>
...
with open('frontend/src/views/WechatAccount.vue', 'w', encoding='utf-8') as f:
    f.write(content)

print("✅ WechatAccount.vue 创建成功！")
